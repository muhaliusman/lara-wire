                    ...
                    <ul class="inline-flex items-center">
                        <li>
                            <button
                                ...
                                aria-label="Previous" wire:click="previousPage" dusk="previousPage.after" rel="prev" @if($paginator->onFirstPage()) disabled @endif>
                        ...
                        <li>
                            <button
                                ...
                                wire:click="nextPage" dusk="nextPage.after" aria-label="Next" @if(!$paginator->hasMorePages()) disabled @endif
                                >
                                <svg class="w-4 h-4 fill-current" aria-hidden="true" viewBox="0 0 20 20">
                                    <path
