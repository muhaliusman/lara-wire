<div class="container px-6 mx-auto grid">
	...
	<div class="w-full flex justify-end pb-4">
		<a class="flex items-center justify-between px-4 py-2 text-xs font-medium text-white transition-colors duration-150 bg-brown-600 border border-transparent rounded-md active:bg-brown-600 hover:bg-brown-700 focus:outline-none focus:shadow-outline-brown uppercase" >
			<span>Add User</span>
		</a>
	</div>
	...
	<div class="w-full overflow-hidden rounded-lg shadow-xs border">
		<div class="w-full overflow-x-auto relative">
			<div
				...
				wire:loading wire:target="perPage, gotoPage, search"
			>
				<span class="uppercase text-sm font-medium bg-brown-500 text-white p-2 rounded-sm">Processing</span>
			</div>
